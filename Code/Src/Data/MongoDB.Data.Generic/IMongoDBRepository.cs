...
namespace MongoDB.Data.Generic
{
    public partial interface IMongoDBRepository<T> where T : MongoDBBaseEntity
    {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        Task<IList<T>> FindByFilterDefinitionAsync(FilterDefinition<T> query);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        Task<T> FindSingleByFilterDefinitionAsync(FilterDefinition<T> query);
        ...
        /// <returns></returns>
        Task<T> FindOneAndUpdateAsync(FilterDefinition<T> filter,
